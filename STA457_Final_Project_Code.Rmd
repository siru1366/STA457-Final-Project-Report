...
# Step 3: Extract model-estimated volatility
...
# Step 4: Compute realized (actual) volatility using rolling std of returns
...
# Step 5: Join GARCH and realized volatilities
combined_vol <- vol_df %>%
...
# Run RF and GBM forecasts using best lag values
...
### Forecast Next 90 Days Using Random Forest
```{r}
